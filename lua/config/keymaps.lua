...
local keymaps = {
  -- Global mappings.
  {
    ...
    -- Window navigation.
    {
      ...
      {"<S-Left>",  "<cmd>wincmd h<CR>", desc = "Go to left window"},
      {"<M-j>",     "<cmd>wincmd j<CR>", desc = "Go to down window"},
      {"<S-Down>",  "<cmd>wincmd j<CR>", desc = "Go to down window"},
      {"<M-k>",     "<cmd>wincmd k<CR>", desc = "Go to up window"},
      {"<S-Up>",    "<cmd>wincmd k<CR>", desc = "Go to up window"},
      {"<M-l>",     "<cmd>wincmd l<CR>", desc = "Go to right window"},
      {"<S-Right>", "<cmd>wincmd l<CR>", desc = "Go to right window"},
